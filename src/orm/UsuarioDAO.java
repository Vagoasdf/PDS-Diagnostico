...
public class UsuarioDAO {
	...
	public static boolean save(orm.Usuario usuario) throws PersistentException {
		try {
			PDSPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Usuario usuario) throws PersistentException {
		try {
			PDSPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Usuario usuario) throws PersistentException {
		try {
			PDSPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Usuario usuario) throws PersistentException {
		try {
			PDSPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
