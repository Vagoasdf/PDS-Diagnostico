...
public class ContactoDAO {
	public static Contacto loadContactoByORMID(int id) throws PersistentException {
		try {
			PersistentSession session = PDSPersistentManager.instance().getSession();
			return loadContactoByORMID(session, id);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Contacto getContactoByORMID(int id) throws PersistentException {
		try {
			PersistentSession session = PDSPersistentManager.instance().getSession();
			return getContactoByORMID(session, id);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto loadContactoByORMID(int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = PDSPersistentManager.instance().getSession();
			return loadContactoByORMID(session, id, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto getContactoByORMID(int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = PDSPersistentManager.instance().getSession();
			return getContactoByORMID(session, id, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto loadContactoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Contacto) session.load(orm.Contacto.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto getContactoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Contacto) session.get(orm.Contacto.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto loadContactoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Contacto) session.load(orm.Contacto.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Contacto getContactoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Contacto) session.get(orm.Contacto.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(orm.Contacto contacto) throws PersistentException {
		try {
			PDSPersistentManager.instance().saveObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Contacto contacto) throws PersistentException {
		try {
			PDSPersistentManager.instance().deleteObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Contacto contacto)throws PersistentException {
		try {
			...
			for(int i = 0; i < lBitacoras.length; i++) {
				lBitacoras[i].setId_contacto(null);
			}
	...
	public static boolean refresh(orm.Contacto contacto) throws PersistentException {
		try {
			PDSPersistentManager.instance().getSession().refresh(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Contacto contacto) throws PersistentException {
		try {
			PDSPersistentManager.instance().getSession().evict(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
